...
callToAction =
    div [ css [ Tw.mx_2, Tw.mt_8, Tw.items_center, Tw.flex, Tw.flex_col, Tw.content_center, justifyContent center, textAlign center, Tw.flex_grow ] ]
        ...
        , h2 [ css [ Tw.mt_0, Tw.font_extrabold, fontSize (rem 1), Tb.md [ fontSize (rem 2) ], Tw.text_color Tc.gray_800, paddingLeft (px 10), paddingRight (px 10), Tw.font_sans ] ] [ text "$85 for adults and $80 students." ]
...
aboutAvailability =
    div [ Attr.id "times", css [ Tw.mt_7, Tw.mx_6 ] ]
        ...
        , div [ css [ Tw.my_4, Tw.mr_3 ] ]
            [ div [ css [ Tw.w_full ] ]
                [ p [ pStd ]
                    [ text "Lessons are $85 per hour for adults, and $80 per hour for students. My general operating hours are as follows:" ]
                , Html.Styled.table
                    [ css [ Tw.w_full ], pStd ]
                    [ tr []
                        [ td [] [ text "Monday" ]
